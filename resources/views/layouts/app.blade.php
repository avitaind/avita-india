...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('css/bootstrap.min.css') }}" disabled/>
    <link type="text/css" rel="stylesheet" href="{{ asset('css/font-awesome.min.css') }}" disabled/>
    <link type="text/css" rel="stylesheet" href="{{ asset('css/global.css') }}" disabled/>
    <link type="text/css" rel="stylesheet" href="{{ asset('css/style.css') }}" disabled/>
