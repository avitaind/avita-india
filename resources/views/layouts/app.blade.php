...
<head>
    ...
    <link rel="stylesheet" async href="{{ asset('css/bootstrap.min.css') }}" />
    <link rel="stylesheet" async href="{{ asset('css/font-awesome.min.css') }}" />
    <link rel="stylesheet" async href="{{ asset('css/global.css') }}" />
