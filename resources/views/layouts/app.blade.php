...
<head>
    ...
    <link async rel="stylesheet" href="{{ asset('css/bootstrap.min.css') }}" />
    <link async rel="stylesheet" href="{{ asset('css/font-awesome.min.css') }}" />
    <link async rel="stylesheet" href="{{ asset('css/global.css') }}" />
