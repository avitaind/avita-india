                    ...
                    <div class="container">
                        ...
                        <ul class="list-unstyled spec-list">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>WiFi IEEE 802.11 b/g/n</div>
                            </li>
                            <li class="spec-item d-flex">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>User Guide, Manuals, AC Adapter, Cleaning Cloth and Power cord</div>
                            </li>
        ...
        <section class="product-statement mt-4 mt-sm-0">
            <div class="container">
                <ul class="product-statement-list border-top py-2 py-sm-5 mx-auto ls-0 pl-4 py-0">
                    ...
                    <li>For details on ssd upgradation please get it touch with our <a href="{{ route('support') }}" target="_blank"><u>customer care</u></a> via call/whatsapp/email.</li>
