...
<section>
   ...
   <div class="row m-5">
      <div class="col-md-6">
         <img class="center" src="{{ asset('/images/sleeves/front_&back.jpg') }}" >
      </div>
      <div class="col-md-6">
         <div>
            <div class="h2 mb-4">AVITA Ubique 3-in-1 sleeve </div>
            <p class="text-justify hidden-sm-down">An ideal laptop bag is one that keeps the device safe. It also acts as a style accessory and adds more to your personality. Our newly launched Avita Ubique 3-in-1 sleeve is designed to give safety to your laptop while making you look fabulous as you do it. </p>
         </div>
      </div>
      <div class="row m-5">
         <div class="col-md-6">
            <div class=" h2 mb-4">Perfect fit for all your needs</div>
         ...
         <div class="col-md-6">
            <img class=" text-center center" src="{{ asset('/images/sleeves/Lifestyle_2.jpg') }}" >
         </div>
      </div>
      <div class="row m-5">
         <div class="col-md-6">
            <img class=" center" src="{{ asset('/images/sleeves/Lifestyle_3.jpg') }}" >
         </div>
         <div class="col-md-6">
            <div class=" h2 mb-4">Available in 4 colours</div>
      ...
      <div class="row m-5">
         <div class="col-md-6">
            <div class=" h2 mb-4">Spacious interiors</div>
         ...
         <div class="col-md-6">
            <img class=" center" src="{{ asset('/images/sleeves/Multicolors.jpg') }}" >
         </div>
      </div>
      <div class="row m-5">
         <div class="col-md-6">
            <img class=" center" src="{{ asset('/images/sleeves/spill_resistant.jpg') }}" >
         </div>
         <div class="col-md-6">
            <div class=" h2 mb-4">Lightweight and comfortable </div>
