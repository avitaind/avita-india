...
@section('content')
    <main class="top-nav-padding">
            ...
            <div class="responsive-block">
                <div class="banner-block responsive-item">
                    <div class="banner-bg hidden-sm-down"
                        style="background-image: url('/images/banner/Liber_V_Desktop_Banner.jpg')"></div>
                    <div class="banner-bg hidden-md-up"
                        style="background-image: url('/images/banner/Liber_V_Mobile_Banner.jpg')"></div>
            ...
            <div class="container">
                ...
                <div class="banner-para">
                    ...
                    <div class="banner-para text-center">
                        ...
                        <span class="buy-now2"><a href="https://in.nexstmall.com/" target="_blank">Buy now
                                ></a></span>
                    ...
                    <div class="banner-info">
                        ...
                        <div class="banner-para ls-0">
                            <span class="d-lg-block">Inspired by the neat geometric lines of La Muralla Roja (The Red
                                ...
                                Aluminum build and equipped with an easy-to-open clip thereby achieving the trifecta </span>
        ...
        <section class="product-liber-banner product-liber-v-banner">
            <div class="responsive-block">
                <div class="banner-bg hidden-sm-down"
                    style="background-image: url('/images/liber-v/Avita_Liber_V_Red_Dot_Award_Web.jpg')"></div>
                <div class="banner-bg hidden-md-up"
                    style="background-image: url('/images/liber-v/Avita_Liber_V_Red_Dot_Award_Mob.jpg')"></div>
        ...
        <section class="product-liber-wifi product-liber-v-view">
            ...
            <div class=" container text-center banner-para ls-0">
                <span class="d-lg-block">LIBER V impressively combines expressive individuality with state-of-the-art
                    technology, paying attention to carefully crafted details such as </span>
            ...
            <div class="banner-block">
                ...
                <div class="container">
                    <div class="banner-info">
                        ...
                        <div class="banner-para ls-0">
                            <span class="d-md-block">The 14 distinctive and flamboyant color options* of LIBER V boost
                                its uniqueness as a personality statement accessory. Now, put your own mark further on LIBER
                                V by opting for Laser Engraving Service for the chassis. We will keep adding more colors and
                                patterns to LIBER V catalog, keeping you spoilt for choices.</span>
            ...
            <div class="banner-block">
                ...
                <div class="container">
                    <div class="banner-info" style="background-image:none;">
                        ...
                        <div class="banner-para ls-0">
                            <span class="d-md-block">The smart design and sophisticated engineering behind LIBER V
                                ensures that the 35.56 cm visage of LIBER V weighs merely 1.25 kgs, 14% lighter than
                                previous LIBER models, LIBER V achieves the ideal in terms of easy mobility factor. Combine
                                that with the fingerprint lock powered by Windows Hello, and LIBER V becomes the perfect
                                technology weapon, easy to carry and ready to be unleashed with a snap and a touch.</span>
                            <span></span>
                        ...
                        <div class="banner-data d-flex flex-wrap text-left mx-auto pl-sm-5 hidden-sm-down">
            ...
            <div class="banner-block">
                ...
                <div class="container">
                    <div class="banner-info" style="background-image:none;">
                        ...
                        <div class="banner-para ls-0">
                            <span class="d-md-block">LIBER V takes an evolutionary step forward in terms of performance
                                parameter by adapting the new 10<sup>th</sup> Gen Intel® Core™i5-10210U/i7-10510U processors
                                and AMD Ryzen™ 5 3500U- AMD Ryzen™ 7 3700U with 8 GB RAM, an ultra-fast SSD Drive up to 1 TB
                                and preloaded Windows 10 home enabling you to tackle even the most complex tasks with practiced ease.</span>
                        ...
                        <div
                            class="banner-data d-flex flex-column flex-sm-row flex-wrap justify-content-center justify-content-sm-between hidden-sm-down" style="margin-top: 15px; margin-left: 1px;">
        ...
        <section class="product-liber-performance product-liber-v-io">
            <div class="banner-block">
                <div class="banner-bg"></div>
                <div class="banner-image">
                    <img class="bc-computer-1" src="/images/liber-v/AVITA_liber_v_io.png" style="margin-top: 40px;">
                </div>
            </div>
        </section>
