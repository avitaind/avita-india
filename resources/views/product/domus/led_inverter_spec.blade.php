                ...
                <div class="tab-pane active" id="spec-1" role="tabpanel">
                    <div class="container">
                        ...
                        <ul class="list-unstyled spec-list">
                            ...
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Rated AC Lamp Wattage</div>
                                <div>9W {+10% Range}</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Rated DC Lamp Wattage</div>
                                <div>3W {+10% Range}</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Lamp CCT</div>
                                <div>Cool White (6500K) ANSI</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Housing</div>
                                <div>A67</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Base Cap</div>
                                <div>B22 & E27</div>
                            </li>
                            <li class="spec-item d-flex">
                            ...
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Rated AC Luminous Flux</div>
                                <div>900lm {-10% Range}</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Rated DC Luminous Flux</div>
                                <div>380lm {-10% Range}</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Battery Charge up Time</div>
                                <div>8Hrs - 10Hrs</div>
                            </li>
                            <li class="spec-item d-flex">
