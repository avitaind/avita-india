                    ...
                    <nav class="nav nav-pills nav-product-spec justify-content-center">
                        <a class="col text-center nav-link active" data-toggle="tab" href="#spec-1" role="tab">
                            <div class="spec-item-name mb-4">
                                <div class="d-sm-block">20W RGBCW SMART LED BATTEN </div>
                                {{-- <div class="d-sm-block">(35.56 cm)</div> --}}
                            </div>
                            <img class="hidden-sm-down" src="/images/domus/20w_led_batten.png">
                        </a>

                        <a class="col text-center nav-link" data-toggle="tab" href="#spec-2" role="tab">
                            <div class="spec-item-name mb-4">
                                <div class="d-sm-block">20W TUNABLE CCT SMART LED BATTEN</div>
                                {{-- <div class="d-sm-block">(35.56 cm)</div> --}}
                            </div>
                            <img class="hidden-sm-down" src="/images/domus/20w_smart_led_batten.png">
                        </a>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="container">
                        ...
                        <ul class="list-unstyled spec-list">
                            <li class="spec-item d-flex">
                                ...
                                <div> 25K Hrs. {at 25ᵒC (±2ᵒC)} </div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Rated Lamp Wattage</div>
                                <div>20W {<+10% Range} for CW & WW</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Lamp CCT</div>
                                <div>From warm white( 3000K) to CW (6500K) & multimilliion colors</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Housing Length {Mounting}</div>
                                <div>3 FEET{900mm} {C-Clamp} </div>
                            </li>
                            <li class="spec-item d-flex">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>2000lm (for 6500K) & 1800lm (for 3000K) {-10% Range}</div>
                            </li>
                            <li class="spec-item d-flex">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>380VAC for 4Hr. & 400VAC for 30Mins</div>
                            </li>
                ...
                <div class="tab-pane " id="spec-2" role="tabpanel">
                    <div class="container">
                        ...
                        <ul class="list-unstyled spec-list">
                            ...
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Housing Length {Mounting}</div>
                                <div>4 FEET{1135mm} {C-Clamp} - ( LXWXH- 1135mm X 24.5mmX 43mm)</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Ingress Protection </div>
                                <div>IP20</div>
                            ...
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Rated Luminous Flux</div>
                                <div>2000lm (for 6500K) & 1800lm (for 3000K)
                                    {-10% Range}</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">CRI</div>
