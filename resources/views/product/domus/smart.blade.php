...
<link rel="stylesheet" href="/domus/css/styles.css">

<script src="/domus/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
...
<body class="is-loading">
  ...
  <div id="intro" class="header-container fs">
      ...
      {{-- <header class="wrapper">
          <h1 class="title">Why We Love Mountains?</h1>
          <p>Find out from these handpicked quotes about mountains and climbing.</p>
      </header> --}}
  ...
  <div id="main" class="main-container">
      ...
      <article id="slide01" class="slide fs">
          ...
          <div class="wrapper">
              ...
              <section>
                  <p class="slideInUp slideInUp2">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
              </section>
          </div> <!-- .wrapper -->
      </article>
      ...
      <article id="cb02" class="content-block">
          <div class="wrapper">
              ...
              <section>
                  <p class="slideInUp slideInUp2">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
              </section>
          </div> <!-- .wrapper -->
      </article>
      ...
      <article id="slide02" class="slide fs">
          ...
          <div class="wrapper">
              ...
              <section>
                  <p class="slideInUp slideInUp2">Climbing is hard to give up, it's just as hard to give up as cigarettes.</p>
              </section>
          </div> <!-- .wrapper -->
      </article>
      ...
      <article id="cb03" class="content-block">
          <div class="wrapper">
              ...
              <section>
                  <p class="slideInUp slideInUp2">Contrary to popular belief, Lorem Ipsum is not simply random text.</p>
              </section>
          </div> <!-- .wrapper -->
      </article>
      ...
      <article id="slide03" class="slide fs">
          ...
          <div class="wrapper" style="color:white">
              ...
              <section>
                  <p class="slideInUp slideInUp2">Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</p>
                  <div class="slideInUp slideInUp3">
                      <a href="https://ihatetomatoes.net/5-days-with-scrollmagic/" class="button download-app">DOWNLOAD NOW</a>
                  </div>
  ...
  <script>window.jQuery || document.write('<script src="/domus/js/vendor/jquery-1.11.2.min.js"><\/script>')</script>
