                    ...
                    <div class="container">
                        ...
                        <ul class="list-unstyled spec-list">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div> RGB OR WHITE (6500K) OR WARM WHITE ( 3000K) </div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Housing</div>
                                <div>A60 15W OVER MOLDED</div>
                            </li>
                            <li class="spec-item d-flex">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>850lm (for 6500K) {-10% Range} OR 765lm (for 3000K)
                                    {-10% Range}</div>
                            </li>
                            <li class="spec-item d-flex">
                ...
                <div class="tab-pane " id="spec-3" role="tabpanel">
                    <div class="container">
                        ...
                        <ul class="list-unstyled spec-list">
                            ...
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Rated Luminous Flux</div>
                                <div>1140lm (for 6500K) {-10% Range} &1025lm( for 3000k) {-
                                    10% range}</div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">CRI</div>
