<div class="nav-product-panel">
    <div class="container">
       ...
       <!---  <li class="nav-item"><a class="nav-link py-1" href="{{ route('product.overview', ['cosmos']) }}">@lang('site.cosmos')</a></li> --->
            <li class="nav-item"><a class="nav-link py-1" href="{{ route('product.spec', 'cosmos') }}">@lang('site.productnav_spec')</a></li>
