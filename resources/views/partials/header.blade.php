            ...
            <ul class="navbar-nav mr-auto d-md-flex flex-md-row align-items-md-center justify-content-md-between">
               ...
               <li class="nav-item has-dropdown">
                    ...
                    <div class="dropdown">
                       <ul class="list-unstyled">
                            ...
                            <li class="nav-item has-dropdown">
                                ...
                                <label for="header_product_domus" class="d-block mb-0"><a class="nav-link px-md-4 py-2" href="{{ route('product.overview', ['domus']) }}">DOMUS (Launching Soon) </a></label>
                                <div class="dropdown">
                                    <ul class="list-unstyled">

                                        <li class="nav-item">

                                            <a class="nav-link px-md-4 py-2" href="{{ route('product.overview', ['smart-lighting']) }}">Smart lighting (coming soon)</a>
                                        </li> 
                                        <li class="nav-item">

                                            <a class="nav-link px-md-4 py-2" href="{{ route('product.overview', ['conventional-lighting']) }}">Conventional lighting (coming soon)</a>
                                        </li>
                                        <li class="nav-item">

                                            <a class="nav-link px-md-4 py-2" href="{{ route('product.overview', ['emergency-lighting']) }}">Emergency lighting (coming soon)</a>
                                        </li>
                ...
                <li class="nav-item has-dropdown">
                    ...
                    <a class="nav-link px-md-4 py-2">    <label for="header_countries" class="d-block mb-0"><img src="/images/maps-and-flags.png"></label></a>
                    <div class="dropdown">
                        <ul class="list-unstyled">
                        <li class="nav-item">
