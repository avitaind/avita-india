         ...
         <img src="/images/background/AVITA_warranty.png" style="width:100%; max-width:600px;">
                    ...
                    <div class="container">
                        <div class="text-center mx-auto px-0 my-0 my-md-5 col-12 col-sm-8 col-md-5">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-left">The entirety of AVITA Laptop products do not support update of Windows
                                    10 S.</p>
                                <p class="text-left">AVITA does not have plans to release Windows 10 S based Laptop
                                    products.</p>

                            </div>
                        </div>
                        <div id="product-driver-wrapper"
                            class="d-flex flex-wrap text-left mx-auto px-0 my-0 my-md-5 col-12 col-md-10 ls-0">
            ...
            <div class="support-center-wrap py-5">
                ...
                <div class="text-center purchase_steps">
                    ...
                    <a href="https://www.avita.com/hk/warranty-extension" target="_blank"
