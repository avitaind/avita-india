...
<?php $__env->startSection('content'); ?>
    <main>
        ...
        <h5 class="text-center mt-4 mb-3 font-weight-light"><?php echo app('translator')->getFromJson('site.blog3'); ?></h5>
