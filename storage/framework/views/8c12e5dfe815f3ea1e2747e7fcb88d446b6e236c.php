...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('partials.rolling-cta-liber-v-gold-blue', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <section class="product-liber-computer product-liber-v-gold-computer">
            <div class="banner-block">
                ...
                <div class="container">
                    ...
                    <div class="banner-info">
                    	<div class="h1 banner-header mb-4 mb-sm-5">Breathtaking Display</div>
                        <div class="banner-para ls-0">
                            <span class="d-lg-block">
                                <div class="row">
                                    <div class="col-md-3">
                                    <img class="bc-computer-image bc-computer-1" src="/images/liber-v-gold/ultra_narrow_bezel_hk_en2.png">
                                    </div>
                                    <div class="col-md-3">
                                    <img class="bc-computer-image bc-computer-1" src="/images/liber-v-gold/anti_glare_screen_hk_en2.png">
                                    </div>
                                    <div class="col-md-3">
                                    <img class="bc-computer-image bc-computer-1" src="/images/liber-v-gold/wide_angle_view_hk_en2.png">
                                    </div>
                                    <div class="col-md-3">
                                    <img class="bc-computer-image bc-computer-1" src="/images/liber-v-gold/screen_body_ratio_hk_en2.png">
                                    </div>
                                </div>
                            </span> 
                        </div> 
                    ...
                    <div class="banner-image">
                    	<img class="bc-computer-image bc-computer-1" src="/images/liber-v-gold/LiberV_14colors_hk_en2.png">
                    </div>
