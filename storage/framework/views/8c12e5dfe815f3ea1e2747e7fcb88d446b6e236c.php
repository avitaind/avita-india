    ...
    <?php echo $__env->make('partials.rolling-cta-liber-v-gold-blue', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
       ...
       <section class="product-liber-computer product-liber-v-gold-keyboard">
        ...
        <div class="color-opt">
            ...
            <div class="slide-text"><a href="<?php echo e(route('product.overview', ['liber-v-gold-blue'])); ?>">Royal Blue</a></div> 
        </div>
...
<?php $__env->startSection('css'); ?>
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('css/liber-v-gold.css')); ?>"/>
<?php $__env->stopSection(); ?>
