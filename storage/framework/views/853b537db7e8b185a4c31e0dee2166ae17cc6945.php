<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('title.blogs'); ?>
...
<?php $__env->startSection('content'); ?>
    <main>
        ...
        <section class="focus-event top-nav-padding">
            <div class="container">
      <h3 class="section-title ls-0 my-5"><?php echo app('translator')->getFromJson('site.blogs_title'); ?></h3>
              <div class="row">
        ...
        <a href="/AVITA-breaks-down-the-Most-Creative-Career-Choices-students-make-today"><p>AVITA breaks down the Most Creative Career Choices students make today</p><br/>
                            <figure>
                                ...
                                <figcaption class="d-flex event-caption coming_soon px-4 py-1">
                                    ...
                                    <div class="event-status coming_soon ml-auto"></strong>Category:</strong>AVITA Liber New Generation</div>
                                </figcaption>
                            </figure>
                        ...
                        <div class="event-item mb-5">
                            ...
                            <figure>
                                ...
                                <figcaption class="d-flex event-caption coming_soon px-4 py-1">
                                    ...
                                    <div class="event-status coming_soon ml-auto"></strong>Category:</strong>SSD Fast Storage</div>
                                </figcaption>
                            </figure>
