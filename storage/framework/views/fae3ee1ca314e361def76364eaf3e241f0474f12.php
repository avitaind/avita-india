...
<!-------------- PURA 14-inch-------------->
                        <a class="col text-center nav-link active" data-toggle="tab" href="#spec-4" role="tab">
                            <div class="spec-item-name mb-4"><div class="d-sm-block">AVITA PURA / PURA E</div><div class="d-sm-block">(35.56 cm)</div></div>
                    ...
                    <div class="container">
                        ...
                        <ul class="list-unstyled spec-list">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>Starting from 1.21 kg / 1.34 kg </div>
                            </li>
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>Up to 10 hours* / 6 hours*</div>
                            </li>
                            
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">Colour</div>
                                <div>Space Grey / Metallic Black / Silky White / Crystal Blue / Glossy Purple / Sugar Red / Shiny Yellow / Pink Diamond / Sparkling Pink /  Ink Black / Shadow Grey / Water Blue* / Bubble Purple* / Crayon Red* / Pink Flower* / Butter Yellow* / Fresh Peach* / Leaf Green* (* To be released)  
