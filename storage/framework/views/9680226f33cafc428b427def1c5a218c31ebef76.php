...
<?php $__env->startSection('content'); ?>
    ...
    <h2 class="text-center mt-4 mb-3 font-weight-light"><?php echo e(__('messages.home_join')); ?></h2>
     ...
     <!---   <p class="download-brochure" ><a href="/images/Revised-Product-Brochure.pdf" target="_blank" download="Revised-Product-Brochure.pdf"><button class="btn btn-primary btn-lg " type="button"><?php echo e(__('messages.brochuer')); ?></button></a></p> --->
