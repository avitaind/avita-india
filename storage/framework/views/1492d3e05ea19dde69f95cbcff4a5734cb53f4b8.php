    ...
    <div class="event-item mb-5">
        <figure>
            ...
            <figcaption class="d-flex event-caption <?php echo e($news->status); ?> px-4 py-1">
                ...
                <div class="event-status <?php echo e($news->status); ?> ml-auto"> Consumer Electronics Show</div>
            </figcaption>
        </figure>
    ...
    <div class="event-item mb-5">
        <figure>
            ...
            <figcaption class="d-flex event-caption <?php echo e($news->status); ?> px-4 py-1">
                ...
                <div class="event-status <?php echo e($news->status); ?> ml-auto"> Avita Liber | India Launch </div>
            </figcaption>
        </figure>
