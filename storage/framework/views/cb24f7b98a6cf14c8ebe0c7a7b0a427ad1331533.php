    ...
    <div class="container">
        <div class="product-nav-toggler h2 text-center my-1 hidden-sm-up">
         ...
         <div class="product-nav-collapse">
            ...
            <li class="nav-item"><a class="nav-link py-1" href="<?php echo e(route('product.overview', ['liber-v-gold'])); ?>"><?php echo app('translator')->getFromJson('site.productnav_overview_liber_v_gold'); ?></a></li>
