<div class="nav-product-panel">
    <div class="container">
        ...
        <div class="dropdown">
         <span class="dropbtn"><a class="nav-link py-1" href="<?php echo e(route('product.overview', ['liber-v-gold'])); ?>"><?php echo app('translator')->getFromJson('site.productnav_overview_liber_v_gold'); ?></a></span>
