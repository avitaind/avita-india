            ...
            <div class="nav-product-wrap">
                <div class="container px-0">
                    ...
                    <a class="col text-center nav-link" data-toggle="tab" href="#spec-3" role="tab">
                            <div class="spec-item-name mb-4"><div class="d-sm-block">AVITA LIBER</div><div class="d-sm-block">12.5" (31.75 cm) <?php if( !$HAVE_LIBER_12): ?> / <?php echo app('translator')->getFromJson('site.coming_soon'); ?> <?php endif; ?></div></div>
                        ...
                        <a class="col text-center nav-link" data-toggle="tab" href="#spec-2" role="tab">
                            ...
                            <ul class="list-unstyled spec-color-list d-flex flex-wrap align-items-center justify-content-center mt-4">
                                ...
                                <li style="background-color: #7d7e82" class="active" data-image="/images/liber/u14/silver.png"></li>
                                <li style="background-color: #c5c2d9" data-image="/images/liber/u14/lightpurple.png"></li>
